     ...
     )
{
  const double twopi = 2.0 * pi;
  int iretn, iret;
  (void)iret; // Suppress unused variable warning
     ...
     )
{
     ...
     (void)thgr;  // Suppress unused variable warning
     (void)thgro; // Suppress unused variable warning
     const double twopi = 2.0 * pi;
